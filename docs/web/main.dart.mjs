...
_1653: v => stringToDartString(v.toString()),
_1654: (d, digits) => stringToDartString(d.toFixed(digits)),
_1658: o => new WeakRef(o),
_1659: r => r.deref(),
_1664: Date.now,
...
_1677: s => stringToDartString(JSON.stringify(stringFromDartString(s))),
_1678: s => printToConsole(stringFromDartString(s)),
_1680: () => globalThis.performance,
_1681: () => globalThis.JSON,
_1682: x0 => x0.measure,
_1683: x0 => x0.mark,
_1684: (x0,x1,x2,x3) => x0.measure(x1,x2,x3),
_1685: (x0,x1,x2) => x0.mark(x1,x2),
_1686: (x0,x1) => x0.parse(x1),
...
_1729: (a, i) => a.push(i),
_1733: a => a.pop(),
_1734: (a, i) => a.splice(i, 1),
_1736: (a, s) => a.join(s),
_1737: (a, s, e) => a.slice(s, e),
_1740: a => a.length,
_1742: (a, i) => a[i],
_1743: (a, i, v) => a[i] = v,
_1745: a => a.join(''),
...
_1804: s => stringToDartString(stringFromDartString(s).toUpperCase()),
_1805: s => stringToDartString(stringFromDartString(s).toLowerCase()),
_1807: (s, m) => {
          try {
...
_1852: l => arrayFromDartList(Uint8Array, l),
...
_1862: stringFromDartString,
_1863: stringToDartString,
_1864: () => ({}),
_1865: () => [],
_1866: l => new Array(l),
_1867: () => globalThis,
_1868: (constructor, args) => {
...
_1870: (o, p) => o[p],
_1871: (o, p, v) => o[p] = v,
_1872: (o, m, a) => o[m].apply(o, a),
_1874: o => String(o),
_1875: (p, s, f) => p.then(s, f),
_1876: s => {
...
_1898: () => globalThis.window,
_1903: (x0,x1) => x0.height = x1,
_1905: (x0,x1) => x0.width = x1,
_1909: x0 => x0.head,
_1911: x0 => x0.classList,
_1916: (x0,x1) => x0.innerText = x1,
_1917: x0 => x0.style,
_1918: x0 => x0.sheet,
_1919: x0 => x0.matches,
_1920: x0 => x0.offsetX,
_1921: x0 => x0.offsetY,
_1922: x0 => x0.button,
_1923: x0 => x0.platform,
_1928: x0 => x0.navigator,
_1935: x0 => x0.status,
